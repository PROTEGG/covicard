 ...
 **************************************************************************************
 ...
 ATTENTION: This code is modified slightly by PROTEGG to fit in its covicard-project. That includes some changes to the grafic elements and an autostart-routine for backcameras of Smartphones. 
...
var c=document.createElement("span");c.innerHTML="",b.appendChild(c);var d=document.createElement("span");

d.id=this.__getStatusSpanId(),d.style.float="right",d.style.padding="5px 7px",d.style.fontSize="14px",d.style.background="#dedede6b",d.style.border="0px solid #00000000",d.style.color="rgb(17, 17, 17)",b.appendChild(d),this.__setStatus("");

var e=document.createElement("div");

e.id=this.__getHeaderMessageContainerId(),e.style.display="none",e.style.fontSize="14px",e.style.padding="2px 10px",e.style.marginTop="4px",e.style.borderTop="0px solid #f6f6f6",b.appendChild(e)}},{key:"__createSection",value:function(a){var b=document.createElement("div");
